...
public class HomeView extends VerticalLayout implements View {
    ...
    @Autowired
    public HomeView(UserService userService, ConversationService conversationService) {
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        ...
        createConvButton.addClickListener((Button.ClickListener) clickEvent -> {
            Conversation conv = conversationService.createConversation(conversationName.getValue());
            UI.getCurrent().getNavigator().navigateTo("/conversation/" + conv.get_id());
        ...
        conversations.forEach(conversation -> {
            ...
            button.addClickListener((Button.ClickListener) clickEvent -> UI.getCurrent().getNavigator().navigateTo("/conversation/" + conversation.get_id()));
